...
namespace Ecommerce
{
    public partial class DatosCliente : System.Web.UI.Page
    {
...

        {
            ...
            string id0 = Request.QueryString["id"] != null ? Request.QueryString["id"].ToString() : ""; //guardo en una varible el ID que me traigo de la URL
            if (negocio1.ValidaDatosClienteCompletos(id0)!=1)
            {
